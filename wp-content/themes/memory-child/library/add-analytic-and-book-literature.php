...
/*** Template Name: Add Analytic and Book Literature */
acf_form_head();
            ...
            <div class="main-body__content">
                <div class="main-body__container">
                    <div class="main-body__breadcrumb">
                        <div class="main-body__breadcrumb--list"><?php //get_breadcrumb();
                                                                    ?></div>
                    </div>
                        ...
                        <div class="catalog">
                            <div class="catalog__add">
                                <div class="catalog__add--title">
                                    <h3>
                                        Analytic and Book Literature Indexing Module
                                    </h3>
                                </div>
                                <div class="catalog__add--content">
                                    ...
                                    acf_form(array(
                                        ...
                                        'updated_message' => __("New Analytic and Book Literature is successfully submitted.", 'acf'),
                                        'new_post' => array(
