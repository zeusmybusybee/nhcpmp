...
/*** Template Name: Add Books and Manuscripts */
acf_form_head();
                        ...
                        <div class="catalog">
                            <div class="catalog__add">
                                <div class="catalog__add--title">
                                    <h3>
                                        Book and Monoggraph Cataloguing Module
                                    </h3>
                                </div>
                                <div class="catalog__add--content">
                                    ...
                                    acf_form(array(
                                        ...
                                        'updated_message' => __("New Books and Manuscripts is successfully submitted.", 'acf'),
                                        'new_post' => array(
