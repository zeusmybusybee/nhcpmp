<div class="tab__content">
    <div class="tab__content--header">
        <div class="tab__content--browse">
            <div class="browse">
                <span>More than 1000+ Browse Serial Cataloging</span>
            </div>
            <div class="button">
    ...
    <div class="tab__content--table">
        ...
        <table id="table_serial" class="display">
            ...
            <?php if ($arg_audiovisual_query->have_posts()) {
                echo 'test working serial';
                $i = 1; ?>
                        ...
                        <tr>
                                ...
                                <div class="catalog">
                                    ...
                                    <div class="catalog__info">
                                        ...
                                        <p class="catalog__info--desc">
                                            <?php echo get_field("s_place_of_publication") ?> :
                                            <?php echo get_field("s_publisher") ?> ,
                                            <?php echo get_field("s_description") ?>
                                        </p>
                                        <p class="catalog__info--id">
                                            <?php echo get_field("s_frequency") ?>
                                        </p>
                                    </div>
                            ...
                            <td class="actions">
                                <div class="table__content--body action">
                                    ...
                                    <a href="<?php echo site_url('/edit-serial'); ?>?post=<?php the_ID(); ?>" class="edit" target="_new">Edit</a>
                                </div>
                            </td>
                        </tr>
                    <?php
