<div class="tab__content">
    <div class="tab__content--header">
        <div class="tab__content--browse">
            <div class="browse">
                <span>More than 1000+ Browse Web Sites</span>
            </div>
            <div class="button">
                <a href="<?php echo site_url('/add-website'); ?>">Add</a>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <div class="table__content--body action">
                            ...
                            <a href="<?php echo site_url('/edit-website'); ?>?post=<?php the_ID();?>" class="edit" target="_new">Edit</a>
                        </div>
                    </td>
                </tr>
                <?php
