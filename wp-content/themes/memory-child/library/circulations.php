          ...
          <div class="main-body__content--header">
            ...
            <div class="watermark library">
              <!-- <img src="<?php //echo THEME_DIR; 
                              ?>/assets/img/circulation.png" alt="Circulation Icon"> -->
            </div>
          </div>
                          ...
                          <?php while ($arg_query->have_posts()) {
                            ...
                            <tr>
                              ...
                              <td><?php
                                  ...
                                  if (get_field('fine_amount')) {
                                    ...
                                    if (get_field('date_due') and get_field('date_due') < date('Y-m-d')) {
                                      ...
                                      $total_days = $days - 1;
                                      echo "₱";
                                      echo $total_days * get_field('g_fine', get_field('p_group_id', get_field('id_number')));
                                      echo ".00";
                                    }
                                  }
                              ...
                              <td>
                                ...
                                <!-- Button trigger modal -->
                                <a class="btn-ci  <?php if (get_field('status') == '2') {
                                                    echo "disabled";
                                                  } ?> " data-toggle="modal" data-target="#checkInModal-<?php echo get_the_ID(); ?>">
                                  Check In
                                </a>&nbsp;&nbsp;<a class="btn-renew <?php if (get_field('status') == '2') {
                                                                      echo "disabled";
                                                                    } ?>" data-toggle="modal" data-target="#RenewModal-<?php echo get_the_ID(); ?>">
                                  Renew
                                </a>
