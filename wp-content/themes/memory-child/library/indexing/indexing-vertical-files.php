<div class="tab__content">
    <div class="tab__content--header">
        <div class="tab__content--browse">
            <div class="browse">
                <span>More than 1000+ Browse Vertical Files</span>
            </div>
            <div class="button">
                <a href="<?php echo site_url('/add-vertical-file'); ?>">Add</a>
            </div>
        </div>
    </div>
    <div class="tab__content--table">
        <table id="table_vertical" class="display">
            <?php
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            $arg_vertical = array(
                'post_type' => 'vertical-file',
                'post_status' => 'publish',
                'posts_per_page' => -1,
                'paged' => $paged
            );
                        ...
                        <tr>
                                ...
                                <div class="catalog">
                                    ...
                                    <div class="catalog__info">
                                        ...
                                        <p class="catalog__info--desc">
                                            <?php echo get_field("vf_source") ?> :
                                            <?php echo get_field("vf_creators") ?> ,
                                            <?php echo get_field("vf_date") ?>
                                        </p>
                                        <p class="catalog__info--id">
                                            <?php echo get_field("vf_reference_code") ?>
                                        </p>
                                    </div>
                            ...
                            <td class="actions">
                                <div class="table__content--body action">
                                    ...
                                    <a href="<?php echo site_url('/edit-vertical-file'); ?>?post=<?php the_ID(); ?>" class="edit" target="_new">Edit</a>
                                </div>
                            </td>
                        </tr>
                    <?php
...
<script>
    $(document).ready(function() {
        ...
        $('#table_vertical_files').DataTable({

            language: {
                searchPlaceholder: "Search Vertical Files",
                search: "",
                paginate: {
                    previous: "<",
                    next: ">"
