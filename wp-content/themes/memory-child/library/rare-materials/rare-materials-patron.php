                    ...
                    <td>
                        <div class="catalog">
                            <div class="catalog__img">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo THEME_DIR; ?>/assets/img/icon/ic_user.png" style="object-fit: contain; background: rgb(35, 77, 141); padding: 8px;" />
                                <?php endif;?>
                                <!--<div class="catalog__img--icon">-->
                                <!--    <img src="<?php echo THEME_DIR; ?>/assets/img/icon/ic_user.png" alt="">-->
                                <!--</div>-->
                            </div>
