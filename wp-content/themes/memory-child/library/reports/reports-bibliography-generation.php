...
<div class="tab__content">
    ...
    <select class="custom-select" name='bibliography_list_data_type' >
    <option value="0">Select Bibliography List:</option>
  ...
  <input type='submit' name='submit' value="Search">
    ...
    <div class="tab__content--table">
            ...
            <?php
             error_reporting(0);
            if($_GET['bibliography_list_data_type']){
          $bibliography_type =  $_GET['bibliography_list_data_type'];
/*------------------------------------------ DISPLAY TABLE ---------------------------------------------------------------------------------*/
            
$arg_accession_list = array(
    'post_type' => "$bibliography_type",
    'post_status' => 'publish',
    'posts_per_page' => -1,
    'paged' => $paged,
);
...
?>
 ...
 <?php if($bibliography_type == 'archive' ){ ?>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'museums' ){ ?>


   <table id="table_accession2" class="display">
                <thead>
                <tr>
                    <th>Subject Depicted Information</th>
                    <th>Format</th>
                    <th>Title </th>
                    <th>Title Type</th>
                    <th>Object name</th>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td><?php echo get_field('m_subjects_depicted_information_m_subjects_depicted'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
                <td><?php echo get_the_title(); ?></td>
...
<?php }elseif($bibliography_type == 'patrons' ){ ?>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('p_subject'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'books-manuscript' ){ ?>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td><?php echo get_field('bm_access_point_tropical'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'academic-courseworks' ){  ?>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td>
                    <?php
                     if(get_field('access_point_tropical')){
                         $terms = get_field('access_point_tropical');
                        if( $terms ): ?>
                     ...
                     if(get_field('bm_access_point_tropical')){
                        $terms = get_field('bm_access_point_tropical');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('ac_subject_keywords')){
                         $terms = get_field('ac_subject_keywords');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('ar_access_point_tropical')){
                         $terms = get_field('ar_access_point_tropical');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('er_subject')){
                         $terms = get_field('er_subject');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('s_subject')){
                         $terms = get_field('s_subject');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('vr_access_point_topical')){
                         $terms = get_field('vr_access_point_topical');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                     ...
                     if(get_field('ws_access_point_topical')){
                         $terms = get_field('ws_access_point_topical');
                        if( $terms ): ?>
                            <?php foreach( $terms as $term ): ?>
                                <span><?php echo esc_html( $term->name ); ?></span>, 
                            <?php endforeach; ?>
                ...
                <td><?php echo get_field('ac_call_number'); ?></td>
...
<?php }elseif($bibliography_type == 'audio-recordings' ){ ?>
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td><?php echo get_field('ar_access_point_tropical'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'video-recording' ){ ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                ...
                <td><?php echo get_field('vr_access_point_topical'); ?></td>
                <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'audio-visual' ){  ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('access_point_tropical'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'e-resources' ){  ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('er_subject'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'serial' ){  ?>
...
<?php }elseif($bibliography_type == 'website' ){ ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('ws_access_point_topical'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'analytic-literature'){ ?>
...
<?php }elseif($bibliography_type == 'cases'){  ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('c_subject'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'periodical-article'){  ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('pa_keyword_subjects'); ?></td>
                 <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
...
<?php }elseif($bibliography_type == 'vertical-file'){  ?>
...
<table id="table_accession2" class="display">
 ...
 <?php while ($arg_query->have_posts()) { $arg_query->the_post();?>
                <tr>
                <td><?php echo get_field('vf_subject_keyword'); ?></td>
             <td><?php echo get_the_title(get_field('format_attribute')); ?></td>
